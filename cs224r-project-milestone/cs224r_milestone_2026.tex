...
$k$ grows. Figure~\ref{fig:rloo_pass_k} shows all three methods on one axis.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{../passk_comparison.png}
  \caption{Pass@$k$ on the held-out set, SFT versus RLOO (IPO also shown for reference). RLOO leads at pass@1 and converges with the baselines as $k$ grows.}
